...
extension ReportPatterns on Report {
  ...
  TResult maybeMap<TResult extends Object?>({
    ...
    final _that = this;
    switch (_that) {
      case Report_TableGeneration() when tableGeneration != null:
        return tableGeneration(_that);
      case Report_Misc() when misc != null:
        return misc(_that);
      case _:
        return orElse();
    }
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    switch (_that) {
      case Report_TableGeneration() when tableGeneration != null:
        return tableGeneration(_that.progress, _that.step, _that.message);
      case Report_Misc() when misc != null:
        return misc(_that.message);
      case _:
        return orElse();
    }
  }
